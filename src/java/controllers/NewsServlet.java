    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (this.action) {
            ...
            case "editComment": {
                ...
                updatedComment.setUserID(Integer.parseInt(request.getParameter("userID")));
            ...
            case "deleteComment": {
                ...
                try {
                    db.createConnection();
                    news.deleteComment(db.conn, Integer.parseInt(urlRequest[1]));
                    db.closeConnection();
                } catch (Exception e) {
                    e.printStackTrace();
                    response.setHeader("dbError", "Unable to connect to the database");
        ...
        try {
            db.createConnection();
            articleList = news.getTopArticles(db.conn);
            userList = users.getAllUsers(db.conn);
            db.closeConnection();

            request.setAttribute("news", articleList);
